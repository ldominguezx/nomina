...
$sql_check = "SELECT id_cuenta FROM empleados_cuentas WHERE numero_cuenta = ?";
$stmt_check = $con->prepare($sql_check);
$stmt_check->bind_param("s", $numero_cuenta);
$stmt_check->execute();
...
$sql = "INSERT INTO empleados_cuentas 
(id_empleado, numero_cuenta, tipo_cuenta, moneda)
VALUES (?, ?, ?, ?)";
