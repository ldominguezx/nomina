...
<div class="row">
    ...
    <div class="col-md-10 p-4">
        ...
        <h3 class="mb-4">Editar Cuenta</h3>

        <div class="card shadow p-4">

        <form action="edit/update_employees_cuenta.php" method="POST" oninput="generarCuenta()">

            <input type="hidden" name="id" value="<?= $row['id_cuenta'] ?>">

            <p><strong>Empleado:</strong> <?= $row['nombre'] ?></p>
            ...
            <div class="row">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <select name="producto" class="form-control">
                        <option value="100" <?= $producto=='100'?'selected':'' ?>>100 - Corriente</option>
                        <option value="200" <?= $producto=='200'?'selected':'' ?>>200 - Ahorro</option>
                    </select>
                </div>
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <select name="moneda" class="form-control">
                        <option value="01" <?= $moneda=='01'?'selected':'' ?>>Colones</option>
                        <option value="02" <?= $moneda=='02'?'selected':'' ?>>Dólares</option>
                    </select>
                </div>

                <div class="col-md-2 mb-3">
                    <label>Oficina</label>
                    <input type="number" name="oficina" class="form-control" value="<?= $oficina ?>">
                </div>

                <div class="col-md-3 mb-3">
                    <label>Cuenta</label>
                    <input type="number" name="cuenta" class="form-control" value="<?= $numero ?>">
                </div>

                <div class="col-md-1 mb-3">
                    <label>DV</label>
                    <input type="number" name="dv" class="form-control" value="<?= $dv ?>">
                </div>
...
function generarCuenta() {
    ...
    let tipo = producto === "100" ? "Corriente" : "Ahorro";
